...
def RatQuadratic(RQ_theta, RQ_l, RQ_alpha):
    f1 = RQ_theta**2
    f2 = RQ_l**2
    f3 = (x1-x2)**2
...
# Periodic Kernel    
def ExpSineSquared(ESS_theta, ESS_l, ESS_P): 
    f1 = ESS_theta**2
    f2 = ESS_l**2
    f3 = (x1-x2)
...
def Local_ExpSineSquared(LESS_theta, LESS_l, LESS_P): 
    f1 = LESS_theta**2
    f2 = LESS_l**2
    f3 = (x1-x2)
    f4 = (x1-x2)**2
